...
class EstimatePolicy
{
    ...
    {
        return $user->can('delete_any_estimate');
    }
    ...
    {
        return $user->can('force_delete_any_estimate');
    }
    ...
    {
        return $user->can('restore_any_estimate');
    }
    ...
    {
        return $user->can('replicate_estimate');
    }
    ...
    {
        return $user->can('reorder_estimate');
    }
}
